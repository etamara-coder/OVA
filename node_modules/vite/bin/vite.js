#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\Erik\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.526\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '205cd99dfaba5226350d4bAk1XFwteUVBXAwYGVFMEDQgGAAYC', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Erik/.vscode/extensions/wallabyjs.console-ninja-1.0.526/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '205cd99dfaba5226350d4bAk1XFwteUVBXAwYGVFMEDQgGAAYC', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

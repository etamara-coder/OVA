...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Erik\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.526\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '20f3484cee03a872f70b9eTB0eFh5ZA1JUAVJcVAMAUlIHClMH', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Erik/.vscode/extensions/wallabyjs.console-ninja-1.0.526/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '20f3484cee03a872f70b9eTB0eFh5ZA1JUAVJcVAMAUlIHClMH', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

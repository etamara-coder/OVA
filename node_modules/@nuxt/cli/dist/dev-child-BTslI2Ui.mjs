...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Erik\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.526\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '205f06338288044c8a98b2H0gaGBkJWQsIWgFVBVsIVAlZBlYM', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Erik/.vscode/extensions/wallabyjs.console-ninja-1.0.526/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '205f06338288044c8a98b2H0gaGBkJWQsIWgFVBVsIVAlZBlYM', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

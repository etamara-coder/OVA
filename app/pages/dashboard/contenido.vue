<template>
  <div class="contenido-page">
    ...
    <div class="figuras-grid">
      <div v-for="figura in figuras" :key="figura.nombre" class="figura-card" @click="abrirModal(figura)">
        ...
        <div class="figura-card__info">
          ...
          <div class="ver-mas"><span :style="{ color: figura.color }">Ver más información →</span></div>
        </div>
      </div>
    </div>
...
const figuras = [
  ...
  },
  {
    ...
    propiedades: ['Los lados opuestos son paralelos e iguales.','Sus cuatro ángulos son rectos (90°).','Sus diagonales son iguales y se bisectan.','El perímetro es P = 2(b + h).','Es un paralelogramo con ángulos rectos.'],
    ...
    curiosidades: ['Las pantallas de TV y computadoras son rectangulares en proporción 16:9.','El rectángulo áureo tiene una proporción especial usada en arte y arquitectura.','La mayoría de las hojas de papel (A4, carta) son rectangulares.'],
  },
  {
    nombre: 'Triángulo',
    ...
    propiedades: ['La suma de sus tres ángulos internos es siempre 180°.','El lado más largo es siempre menor que la suma de los otros dos.','La altura es la distancia perpendicular de un vértice a la base.','El perímetro es P = a + b + c.','Tiene tres medianas, tres alturas y tres bisectrices.'],
  ...
  },
  {
    ...
    propiedades: ['Todos los puntos de la circunferencia equidistan del centro.','El diámetro es el doble del radio: d = 2r.','El número π es la relación entre la circunferencia y el diámetro.','La circunferencia (perímetro) es C = 2πr.','Es la figura con mayor área para un perímetro dado.'],
  ...
  },
  {
    ...
    propiedades: ['Solo un par de lados son paralelos (las bases).','Los lados no paralelos se llaman lados oblicuos o laterales.','La mediana mide (B + b) / 2.','El perímetro es la suma de sus cuatro lados.'],
    ...
    curiosidades: ['Los puentes en arco tienen secciones trapezoidales para distribuir el peso.','Muchas presas de agua tienen una sección transversal trapezoidal.','Las bolsas de papel suelen tener forma trapezoidal en su base.'],
  },
  {
    nombre: 'Rombo',
    ...
    propiedades: ['Sus cuatro lados son iguales.','Sus diagonales se cortan en ángulo recto.','Las diagonales se bisectan mutuamente.','Los ángulos opuestos son iguales.','El perímetro es P = 4l.'],
    ...
    curiosidades: ['El símbolo del palo de diamantes en las cartas de juego tiene forma de rombo.','Las señales de peligro en carreteras suelen ser rombos en algunos países.','Los campos de béisbol tienen forma de rombo visto desde arriba.'],
  },
  {
    ...
    propiedades: ['Los lados opuestos son paralelos e iguales.','Los ángulos opuestos son iguales.','La suma de ángulos adyacentes es 180°.','Las diagonales se bisectan mutuamente.','El rectángulo es un caso especial del paralelogramo.'],
    ...
    curiosidades: ['Los romboides aparecen en diseños de baldosas y mosaicos.','Las fuerzas en física se representan como paralelogramos (regla del paralelogramo).','Muchos cristales tienen estructuras con formas de paralelogramo.'],
  },
  {
    ...
    formula: 'A = (P × a) / 2', variables: ['P = perímetro (5 × lado)', 'a = apotema (distancia del centro al lado)'],
    svg: mkSvg([
      ...
      h('text', { x:46, y:58, 'font-size':9, fill:'#7c3aed', 'font-family':'DM Sans' }, 'a'),
    ]),
    propiedades: ['Tiene 5 lados y 5 ángulos iguales.','Cada ángulo interior mide 108°.','La suma de sus ángulos interiores es 540°.','La apotema es la distancia del centro al punto medio de cada lado.','El perímetro es P = 5 × l.'],
...
.contenido-page { font-family:'DM Sans',sans-serif; display:flex; flex-direction:column; gap:28px; }

.page-banner { background:linear-gradient(135deg,#0c1120 0%,#0d1f3c 50%,#0a1628 100%); border-radius:14px; padding:28px 32px; border:0.5px solid rgba(255,255,255,0.08); }
...
.figura-card__badge { font-size:13px; font-weight:600; padding:3px 10px; border-radius:20px; }
...
.variables p { font-size:12.5px; color:#334155; margin:0; font-weight:500; }
.ver-mas { font-size:12px; font-weight:500; margin-top:4px; }
...
.modal__cerrar { width:32px; height:32px; border-radius:8px; background:rgba(0,0,0,0.06); border:none; display:flex; align-items:center; justify-content:center; cursor:pointer; color:#64748b; flex-shrink:0; transition:background 0.15s; }
